...
void main() {
  testWidgets('ErrorReporter does not call ScaffoldMessenger during build '
      '(showSnackBar deferred to the post-frame callback)', (tester) async {
  ...
  testWidgets('ErrorReporter renders nothing visible besides the SnackBar '
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(body: ErrorReporter(message: 'x')),
      ),
    );
    await tester.pump();
